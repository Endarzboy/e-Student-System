	...
	<%
		...
		if (request.getParameter("save") != null) {
			...
			if (currentDate.compareTo(dateForExam) < 0) {
				boolean add = esdDao.AddSchedule(es);
				if (add) {
					msg = "Schedule has been Scheduled";
				} else {
					msg = "No schedule has been made";
				}
			} else {
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label>Notice:</label>
						<textarea rows="7" cols="100" name="notice" class="form-control"
							style="width: 500px;"></textarea>
					</div>

					<div class="form-group">
						<input type="submit" name="save" value="Post Schedule"
