...
<%
	String downloadID =request.getParameter("downloadHoID");
	...
	try {
		...
		String selectToDownload = "SELECT HandoutFile,FileName,FileSize FROM Handout WHERE HandoutID=?";
		...
		blobData = rSet.getBlob("HandoutFile");
