...
<%
	String downloadID =request.getParameter("downloadUploadedID");
	...
	try {
		...
		String selectToDownload = "SELECT AssignFile,FileName,FileSize FROM SubmittedAssignments WHERE AssignID=?";
		...
		blobData = rSet.getBlob("AssignFile");
