...
<%
	...
	if (isMultiPart) {
		...
		String fileName = "", course = "", stream = "", dept = "", instructor = "", semester = "",
				filePath = "", batch = "";
		...
		boolean inserted = mhoDao.InsertHandout(ho, filePath);//(at, filePath);//E:\Selams_Project\JSP_Basic_Tutorials\Final.Documentation\Sent.Documents\Chapter.2-3.docx
		if (inserted) {
			msg = "Handout has been Uploaded Successfully";
		} else {
			msg = "Failed Uploading Handout";
		}
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<input type="submit" name="uploadHandout" value="Upload Handouts"
