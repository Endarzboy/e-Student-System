...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <a
		class="navbar-brand" href="iindex.jsp">OASaAES</a>
	...
	<div class="collapse navbar-collapse" id="navbarColor02">
		<ul class="navbar-nav mr-auto">
			...
			<!-- <li class="nav-item"><a class="nav-link"
				href="viewTeachers.jsp">Teachers</a></li>
			<li class="nav-item"><a class="nav-link" href="viewStudent.jsp">Student</a></li>
			<li class="nav-item"><a class="nav-link" href="viewCourseOffer.jsp">Course Offer</a></li>
			<li class="nav-item"><a class="nav-link" href="viewStudCourse.jsp">Course ~ Student</a></li>
			<li class="nav-item"><a class="nav-link" href="viewSchedule.jsp">Exam Schedule</a></li> -->
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li style="float: right; margin-top: 7px; color: red;">Welcome:
				<a href="viewProfile.jsp"><%=instname.getFullName()%></a>
			</li>
			<%//}
				} else {
			%>
